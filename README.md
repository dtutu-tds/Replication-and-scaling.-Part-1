...
![Скриншот 2 - Master-Slave репликация](screenshots/2.png)
...
![Скриншот 3.1 - Состояние первого сервера Master-Master](screenshots/3.1.png)

*Скриншот показывает состояние mysql-master1 в конфигурации master-master*

![Скриншот 3.2 - Состояние второго сервера Master-Master](screenshots/3.2.png)
